...
import 'package:flutter_database/design_page.dart';
...
import 'package:flutter_database/splash_screen.dart';


final databasehelper =Helperdb();
void main()async
{
  WidgetsFlutterBinding.ensureInitialized();
  await databasehelper.initialization();
  runApp(const MyApp());
}
